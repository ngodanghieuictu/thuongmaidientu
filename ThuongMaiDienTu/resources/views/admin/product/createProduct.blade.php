                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- Tab panes -->
                            {!! Form::open(['url' => Route('product.store'), 'class' => 'tab-content form-horizontal', 'role' => 'form']) !!}
                            <div class="tab-pane fade show active" id="vi">
                              ...
                              <div>
                                <div class="form-group {{ ($errors->has('nameproduct.vi')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                    {!! Form::text('nameproduct[vi]',null,['class'=>'form-control']) !!}
                                ...
                                <div class="form-group {{ ($errors->has('brand.vi')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                    {!! Form::textarea('brandproduct[vi]',null,['class'=>'form-control', 'rows'=>3]) !!}
                                ...
                                <div class="form-group {{ ($errors->has('content.vi')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                    {!! Form::textarea('descriptionproduct[vi]',null,['class'=>'form-control', 'id'=>'description_vi']) !!}
                            ...
                            <div class="tab-pane fade" id="en">
                              <p></p>
                                ...
                                <div class="form-group {{ ($errors->has('nameproduct.en')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                    {!! Form::text('nameproduct[en]',null,['class'=>'form-control']) !!}
                                ...
                                <div class="form-group {{ ($errors->has('brandproduct.en')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                    {!! Form::textarea('brandproduct[en]',null,['class'=>'form-control', 'rows'=>3]) !!}
                                ...
                                <div class="form-group {{ ($errors->has('descriptionproduct.en')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                    {!! Form::textarea('descriptionproduct[en]',null,['class'=>'form-control', 'id'=>'description_en']) !!}
                            ...
                            {{-- <div class="form-group {{ ($errors->has('photo2')) ? 'has-error' : '' }}">
                                <label for="photo" class="col-sm-3 control-label">Photo</label>
                                <div class="col-sm-7">
                                {!! Form::hidden('img2', '', ['id'=>'photo']) !!}
                                <a href="javascript:openCustomRoxy()"><img src="{{old('photo', '/img/no-photo.png')}}" id="customRoxyImage2" style="max-width:200px;"></a>
                                <div class="roxyCustomPanel" id="roxyCustomPanel2" style="display: none;">
                                  <iframe src="/asset/fileman/index.html?integration=custom" style="width:100%;height:100%" frameborder="0"></iframe>
                                </div>
                                </div>
                            </div> --}}
